...
def upgrade() -> None:
    ...
    op.alter_column("users", "password_hash", existing_type=sa.Text(), nullable=True)    op.execute(text("ALTER TABLE organizations ADD COLUMN IF NOT EXISTS default_geography TEXT"))
