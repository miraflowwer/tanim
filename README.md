...
[![Tests](https://img.shields.io/badge/tests-dataset%20audit-2ea44f)](.github/workflows/dataset-audit.yml)
...
- [scripts/service.py](scripts/service.py): Step 7 local JSON service
- [web/README.md](web/README.md): farmer-facing MVP interface
- [docs/DEMO_RUNBOOK.md](docs/DEMO_RUNBOOK.md): live demo and backup steps
...
- [tests/test_service.py](tests/test_service.py): service contract checks
- [tests/test_mvp_e2e.py](tests/test_mvp_e2e.py): local API and UI contract checks
